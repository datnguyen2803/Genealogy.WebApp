...
export function Login(user_name, password) {
	...
	let response = CallAPI(APIConstant.CONTROLLERS.USER, APIConstant.ACTIONS.USER_LOGIN, body);
...
export function SignUp(user_name, password) {
	...
	let response = CallAPI(APIConstant.CONTROLLERS.USER, APIConstant.ACTIONS.USER_SIGN_UP, body);
